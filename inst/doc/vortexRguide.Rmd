...
download the latest version from [r-project.org](www.r-project.org) for your 
operating system. 
...
**_Pacioni C, and Mayer F. 2017. VortexR: an R package for post Vortex simulation analysis. Methods in Ecology and Evolution._**  
